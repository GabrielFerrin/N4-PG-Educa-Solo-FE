    ...
    <div className="login-cmp">
      <div className='header-login-cmp'>
        ...
        <div className="botones-container">
          ...
          <Link to="/Register"><button className='registrarse-boton-cmp'>REGISTRARSE</button></Link>
        </div>
      </div>
      ...
      <div className="main-login-cmp">
        ...
        <div className="box-login-cmp">
          ...
          <form onSubmit={handleSubmit} className='from-login-cmp'>
            {/* <input type="text" placeholder="Username" name="username" className="input-box-cmp" /> */}
            {/* <input type="password" placeholder="Password" name="password" className="input-box-cmp" /> */}
            ...
            <button type="submit" className='from-button-cmp'>INICIAR</button>
          </form>
        </div>
      </div>
    </div>
