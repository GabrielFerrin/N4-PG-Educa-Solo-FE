...
const Register = () => {
  ...
  return (
    <div className="register-cmp">
      <div className='header-register-cmp'>
        <Link to="/home"><img src={logoSrc} alt="" /></Link>
        <div className="botones-container">
          <button className='theme-toggle-btn'>
            {isLightTheme ? (
              <svg onClick={toggleTheme} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 36.19 36.19">
              ...
              <svg onClick={toggleTheme} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 36.09 38.12">
          ...
          <Link to='/login'><button className='logearse-boton-cmp'>Acceder</button></Link>
        </div>
      </div>

      <div className="main-register-cmp">

        <div className="box-register-cmp">
          <h2>Registrarse</h2>
          <form ref={form} className='from-register-cmp'>

          <div className='input-box-cmp'>
              <div className='logo-input-cmp'>
                <img src='../public/user-icon.svg' alt="Icono usuario" className='usuario-icon' />
              </div>
            ...
            <div className='input-box-cmp'>
              <div className='logo-input-cmp'>
                <img src='../public/locker-icon.svg' alt="Icono locker" className='locker-icon' />
              </div>
              <input type="password" placeholder="Password" name="hash" />
            </div>

            <button id="register" type="button" onClick={handleSubmit} className='from-button-cmp'>REGISTRARSE</button>

            {/* <div className='code-box-cmp'>
              <input type="number" placeholder="code" name="code" />
            </div> */}

            {/* <button id="code" type="button" onClick={handleSubmit} className='from-button-cmp'>Generate code</button> */}
          </form>
        </div>
